...
import "./BlantonsDescription.css"
import bourbonImage from "../assets/bourbon.png"

function BlantonsDescription() {
        ...
        <div className="bourbon-content-section">
          ...
          <div className="bourbon-header-info">
            <div className="bourbon-name-section">
              <h2 className="bourbon-name">Blantons</h2>
          ...
          <p className="bourbon-description-text">
            Blanton's Bourbon is produced by the Jim Beam distillery in Clermont,<br />
             Kentucky.<br /><br/>
...
export default BlantonsDescription
